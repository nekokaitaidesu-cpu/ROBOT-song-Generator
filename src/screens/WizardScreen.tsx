  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.selectionArea}>
        {copyMode ? (
          <View>
            <Text style={styles.selectLabel}>/// コピー元を選べ ///</Text>
            {filledLines.length === 0 ? (
              <Text style={styles.copyEmptyText}>コピー可能な行がないぞ！</Text>
            ) : (
...
const styles = StyleSheet.create({
  ...
  selectionArea: {
    borderTopWidth: 1,
    borderTopColor: COLORS.blazeRedBorder,

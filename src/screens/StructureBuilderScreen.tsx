...
const SECTION_COLORS: Record<SectionType, string> = {
  intro: COLORS.hotGold,
  verse: COLORS.burningOrange,
  'pre-chorus': COLORS.steelBlue,
  chorus: COLORS.blazeRed,
  bridge: '#b388ff',
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>作戦X(エクストラ)</Text>
        <Text style={styles.subtitle}>ブロックを組み合わせて作戦を立案せよ！</Text>
      </View>
      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.contentInner}>
        ...
        {sections.length > 0 && (
          <View style={styles.flowPreview}>
            <Text style={styles.flowPreviewLabel}>/// 作戦フロー ///</Text>
